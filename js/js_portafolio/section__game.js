...
const paddleSound = new Audio('../src/assets/sound/sound_portafolio/paddle.wav');
const obstacleSound = new Audio('../src/assets/sound/sound_portafolio/paddle.wav');
const wallSound = new Audio('../src/assets/sound/sound_portafolio/paddle.wav');
const holeSound = new Audio('../src/assets/sound/sound_portafolio/hole.wav');
const startButtonSound = new Audio('../src/assets/sound/sound_portafolio/start.wav');
const loseSound = new Audio('../src/assets/sound/sound_portafolio/lose.wav');
